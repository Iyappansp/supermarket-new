...
(function(){
  ...
  window.FM_PRODUCTS = [
    ...
    { id:15, name:"Golden Delicious Apples (1kg)", cat:"Fresh Produce", img: IMG+"p-apple.png", price:3.19, old:null, rating:4.5, badge:null, off:null },
    { id:16, name:"Greek Style Yogurt (500g)", cat:"Dairy", img: IMG+"p-cheese.png", price:3.49, old:null, rating:4.7, badge:"new", off:null }
  ];
